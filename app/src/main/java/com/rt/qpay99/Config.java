...
public class Config {
    public static boolean isDebug = true; // default: false
    public static boolean showLog = true; // default: false
...
//    public static String FirebaseStoragePassword = "1qazxsw23";
    ...
    public static String FirebaseStorageID = "srsphoto99@gmail.com";
    public static String FirebaseStoragePassword = "kentlee123";
