...
//        window.setStatusBarColor(ContextCompat.getColor(mContext,R.color.qpay));
        ...
        btnLogin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                DLog.e(TAG, "----------------------> " + FunctionUtil.getIPAddress());
                        ...
                        Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION))
                {
                    ...
                    SRSApp.mFirebaseAnalytics.logEvent("LoginUI", params);
...
//                    new CheckLoginValidateAsync().execute();
                    ...
                    PermissionsUtil.requestPermissions(LoginUI.this, 1, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE, Manifest.permission.CAMERA,
                            Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION
                    });
                }
...
//                }
        ...
        biometricPrompt = new BiometricPrompt(LoginUI.this, executor, new androidx.biometric.BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationError(int errorCode, @NonNull CharSequence errString) {
                ...
                //error auth
                //ouchText.setText("Authentication error: " +errString);
            ...
            public void onAuthenticationSucceeded(@NonNull androidx.biometric.BiometricPrompt.AuthenticationResult result) {
                ...
                sClientUserName = SharedPreferenceUtil.getBioName();
                SharedPreferenceUtil.editBioName(sClientUserName);
                sClientPassword = SharedPreferenceUtil.getBioPassword();
                SharedPreferenceUtil.editBioPassword(sClientPassword);
                DeviceLoginAsync();
            }
...
//                startActivity(i);
        ...
        //touch id function
        idTouch.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {

                String checkIdTouch = SharedPreferenceUtil.getBioName();
                DLog.e(TAG, checkIdTouch);

                if (checkIdTouch.length() < 1) {
                    Intent i = new Intent(mContext, LoginBiometric.class);
                   startActivity(i);
                }
//
                else {
                    DLog.e(TAG, "GGWP saved data fingerprint ");
                    DLog.e(TAG, "CHECK ID TOUCH " + checkIdTouch);
...
//        new versionCheck().execute();
    ...
    private class idTouchCheck extends AsyncTask<Void, Void, Boolean> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //pd = new ProgressDialog(mContext);
            pd.setMessage("Data Fingerprint checked");
            pd.show();
