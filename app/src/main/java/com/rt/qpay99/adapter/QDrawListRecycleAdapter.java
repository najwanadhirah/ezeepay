...
public class QDrawListRecycleAdapter extends RecyclerView.Adapter<QDrawListRecycleAdapter.MyViewHolder> {
    ...
    public QDrawListRecycleAdapter(Context mContext, ListenerInterface.RecyclerViewClickListener itemClickListener, List<RedeemObj> RedeemObjs) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        try {
            ...
            holder.tvPoint.setText(p.get(position).getRedeemPoints()  + " QPoints / Ticket");
