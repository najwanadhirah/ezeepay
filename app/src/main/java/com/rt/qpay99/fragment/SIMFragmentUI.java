...
import com.rt.qpay99.listener.SimGridviewOnItemClickListener;
...
public class SIMFragmentUI extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gdSIM = (GridView) rootView.findViewById(R.id.gdTopup);
		gdPinInfo = SharedPreferenceUtil.getPRODUCT_SIM_PREFERENCE();

        if(gdPinInfo != null){
            SIMAdapter = new TopupAdapter(this.getActivity(), gdPinInfo);
            gdSIM.setAdapter(SIMAdapter);
            gdSIM.setOnItemClickListener(new SimGridviewOnItemClickListener(this
