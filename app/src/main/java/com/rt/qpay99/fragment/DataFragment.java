...
public class DataFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gdTopUpInfo = SharedPreferenceUtil.getPRODUCT_DATA_PREFERENCE();
...
//        gdTopUp.setLayoutManager(new GridLayoutManager(getActivity(), numberOfColumns));
        ...
        gdTopUp.setAdapter(new BuyTopupRecycleAdapter(mContext, new mRecyclerViewOnItemClick(), Constants.IMG_OTHERS,gdTopUpInfo,true));
